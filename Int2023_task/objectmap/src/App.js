...
function App() {
  return (
    <div className="App">
      <h1>OBJECT DATA MAP</h1>
    </div>
  );
}

const data = {"KEY1":"VALUE1","KEY2":"VALUE"};
    ...
    <div>
        <table border="1 px solid black">
        {
          ...
          Object.keys(data).map(
            (items,i)=>{
              return <tr><td>{items}</td><td>{data[items]}</td></tr>
            }
          )
        }
        </table>
